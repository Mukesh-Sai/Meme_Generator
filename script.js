...
function showMeme() {
  ...
  const memeNode =document.querySelector('.meme-content');
  const meme=document.createElement('img');
  meme.src=randomMemeUrl;
  
  clearAll();
  memeNode.appendChild(meme);
}
...
function showJoke() {
  ...
  const jokeNode=document.querySelector('.joke-content');
  const randomJokeText = getRandomData('jokes');
  const joke=document.createElement('p');
  joke.textContent=randomJokeText;
  
  clearAll();
  jokeNode.appendChild(joke);
}
...
function showQuote() {
  ...
  const quoteNode =document.querySelector('.quote-content');
  const quoteValue=document.createElement('p');
  quoteValue.textContent=randomQuote.quote;
  const authorValue=document.createElement('p');
  authorValue.textContent=" -"+randomQuote.author;
  
  clearAll();
  quoteNode.appendChild(quoteValue);
  quoteNode.appendChild(authorValue);
...
*/
function showRiddle() {
  const riddleNode =document.querySelector('.riddle-content');
  // Value should be in format: { question: '', answer: '' }
  const randomRiddle = getRandomData('riddles'); 
  const questionNode=document.createElement('p');
  questionNode.textContent=randomRiddle.question;
  
  const answerNode=document.createElement('p');
  answerNode.textContent=randomRiddle.answer;
  answerNode.setAttribute('id','riddle-answer');
  answerNode.hidden=true;
  
  clearAll();
  
  riddleNode.append(questionNode);
  riddleNode.append(answerNode);
...
function revealAnswers() {
  const riddleNode=document.querySelector('.riddle-content');
  const questionNode=riddleNode.querySelector('p');
  const answerNode=document.querySelector('#riddle-answer');
  
  if(questionNode && answerNode.hidden){
